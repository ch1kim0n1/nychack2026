...
export const IntakeTextarea = forwardRef<HTMLTextAreaElement, IntakeTextareaProps>(
  ({ className, onAnalyze, analyzing, value, ...props }, ref) => (
    <div className="relative rounded border border-[var(--cl-border)] bg-surface focus-within:border-[var(--cl-border-strong)] focus-within:ring-2 focus-within:ring-[color-mix(in_srgb,var(--cl-navy-600)_40%,transparent)] transition-[border-color,box-shadow] duration-[140ms]">
      <textarea
        ref={ref}
        value={value}
        rows={4}
